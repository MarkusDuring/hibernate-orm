 ...
 */
public abstract class ArrayBinder<J> implements ValueBinder<J> {
	...
	public ArrayBinder(JavaTypeDescriptor<J> javaDescriptor, SqlTypeDescriptor sqlDescriptor) {
	...
	public final void bind(PreparedStatement st, J value, int index, WrapperOptions options) throws SQLException {
		if ( value == null ) {
			...
			st.setNull( index, sqlDescriptor.getSqlType(), getTypeName( options ) );
		}
		else {
			if ( log.isTraceEnabled() ) {
				log.trace(
	...
	public final void bind(CallableStatement st, J value, String name, WrapperOptions options) throws SQLException {
		if ( value == null ) {
			...
			st.setNull( name, sqlDescriptor.getSqlType(), getTypeName( options ) );
		}
		else {
			if ( log.isTraceEnabled() ) {
				log.trace(
	...
	protected abstract String getTypeName(WrapperOptions options) throws SQLException;
