...
public class OffsetDateTimeJavaDescriptor
	...
	@Override
	public SqmLiteral<OffsetDateTime> createLiteralExpression(SessionFactoryImplementor sessionFactory, BasicType<OffsetDateTime> basicType, OffsetDateTime value) {
		return null;
	}
